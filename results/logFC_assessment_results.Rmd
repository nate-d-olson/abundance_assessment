...
```{r}
ggsave("~/Projects/MGTST-Manuscript/logFCerror-1.pdf", width = 170, units = "mm")
```
...
```{r}
ggsave("~/Projects/MGTST-Manuscript/logFcErrorMetrics-1.pdf", width = 170, units = "mm")
```
...
ggsave("~/Projects/MGTST-Manuscript/diff_abu_metrics.pdf", height = 3, width = 5)
```
