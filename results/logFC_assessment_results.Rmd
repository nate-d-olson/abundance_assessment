...
```{r}
ggsave("figs/logFCerror-1.pdf", width = 170, units = "mm")
```
...
```{r}
ggsave("figs/logFcErrorMetrics-1.pdf", width = 170, units = "mm")
```
...
ggsave("figs/diff_abu_metrics.pdf", height = 3, width = 5)
```
